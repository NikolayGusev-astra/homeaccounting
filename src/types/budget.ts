...
export type ExpenseCategory = 'кредиты' | 'коммунальные' | 'домашние_траты' | 'здоровье' | 'автомобиль' | 'прочее' | 'переводы';

export type ExpenseSubcategory = 
  // Коммунальные
  | 'электро' | 'газ' | 'вода' | 'отопление' | 'интернет' | 'тв'
  // Домашние траты
  | 'продукты' | 'бытовая_химия' | 'косметика' | 'ремонт'
  // Здоровье
  | 'аптека' | 'клиника' | 'спорт'
  // Автомобиль
  | 'ремонт_авто' | 'заправка' | 'обслуживание';

export type ExpenseSubcategoryDetail = 
  // Коммунальные
  | 'электро' | 'газ' | 'вода' | 'интернет' | 'тв'
  // Здоровье
  | 'аптека' | 'клиника' | 'спорт'
  // Обслуживание авто
  | 'ремонт_авто' | 'запчасти' | 'масло' | 'мойка' | 'шиномойка'
  // Транспорт
  | 'ремонт_авто' | 'транспорт' | 'топливо' | 'парковка' | 'пошлина'
  // Образование
  | 'учебники' | 'курсы' | 'каникулы' | 'книги'
  // Развлечения
  | 'кафе' | 'рестораны' | 'кино' | 'театры' | 'путешествия'
  // Прочее
  | 'одежда' | 'обувь' | 'сумки' | 'аксессуары'
  // Красота
  | 'мебель' | 'техника' | 'электроника' | 'игры'
  // Питомцы
  | 'ветерина' | 'зоомагазин' | 'фитнес'
  // Спорт
  | 'фитнес_клуб' | 'абонемент' | 'санаторий'
  // Прочее
  | 'медицина' | 'аптека' | 'больничный' | 'стоматолог'
  // Подписки
  | 'netflix' | 'spotify' | 'youtube' | 'apple_music'
  // Банковские услуги
  | 'связь' | 'интернет'
  // Ипотека
  | 'ипотека'
  ...
  | 'прочее'
  // Алкоголь и табак
  | 'алкоголь' | 'табак' | 'сигареты'
  // Хобби
  | 'каникулы' | 'игры_консоли' | 'книги_печатные'
  // Страхование
  | 'осаго' | 'страховка_авто' | 'страховка_имущества'
  // Налоги
  | 'налоги' | 'штрафы' | 'судебные_расходы'
  // Инвестиции
  | 'акции' | 'облигации' | 'крипто'
  // Прочее
  | 'cashback' | 'кэшбэк'
  // Прочее
  | 'прочие_расходы'
